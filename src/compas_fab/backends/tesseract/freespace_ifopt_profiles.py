"""Validated forwarding to Tesseract's Freespace TrajOptIfopt pipeline profile factory."""

from __future__ import annotations

from tesseract_robotics.planning import create_freespace_ifopt_pipeline_profiles
from tesseract_robotics.tesseract_command_language import ProfileDictionary

from .errors import InvalidTesseractFreespaceIfoptProfileError
...
def build_freespace_ifopt_profiles(
    ...
    """Validate and forward every native Freespace TrajOptIfopt pipeline profile option.
    ...
    Returns:
        The native ProfileDictionary produced by the Freespace TrajOptIfopt pipeline factory.

    Raises:
        InvalidTesseractFreespaceIfoptProfileError: An argument violates its native contract.
    """
    error = InvalidTesseractFreespaceIfoptProfileError
    ...
    return create_freespace_ifopt_pipeline_profiles(**kwargs)
