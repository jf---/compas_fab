...
def test_planner_owns_exact_client(kinematics_harness: PlannerContractHarness) -> None:
    assert kinematics_harness.planner.client is kinematics_harness.client


def test_planner_exposes_installed_cell(kinematics_harness: PlannerContractHarness) -> None:
