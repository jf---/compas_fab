...
Build, Yak, and release workflows fail before upload or publication unless both
`Cf_TesseractRobotArtifact.ghuser` and `Cf_TesseractPlanner.ghuser` were
generated. Their source-level `# r:` directive requires released
